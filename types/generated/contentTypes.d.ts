...
export interface ApiExcelImportExcelImport extends Struct.CollectionTypeSchema {
  collectionName: 'excel_imports';
  info: {
    singularName: 'excel-import';
    pluralName: 'excel-imports';
...
export interface ApiSemesterSemester extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    semester_id: Schema.Attribute.String;
    semester_name: Schema.Attribute.String;
    semester_status: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    id_number: Schema.Attribute.String & Schema.Attribute.Unique;
...
export interface ApiStudentSubjectStudentSubject
  extends Struct.CollectionTypeSchema {
...
export interface ApiTeacherAccountTeacherAccount
  extends Struct.CollectionTypeSchema {
  collectionName: 'teacher_accounts';
  info: {
    singularName: 'teacher-account';
    pluralName: 'teacher-accounts';
    displayName: 'TeacherAccount';
    description: '';
  };
  options: {
    draftAndPublish: false;
